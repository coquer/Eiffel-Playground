...
extern EIF_TYPED_VALUE F883_7235(EIF_REFERENCE);
extern EIF_TYPED_VALUE F883_7236(EIF_REFERENCE);
extern EIF_TYPED_VALUE F883_7237(EIF_REFERENCE);
extern EIF_TYPED_VALUE F883_7238(EIF_REFERENCE);
extern EIF_TYPED_VALUE F883_7239(EIF_REFERENCE);
extern EIF_TYPED_VALUE F883_7240(EIF_REFERENCE);
extern EIF_TYPED_VALUE F883_7241(EIF_REFERENCE);
extern EIF_TYPED_VALUE F883_7242(EIF_REFERENCE);
...
EIF_TYPED_VALUE F883_7235 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F883_7235,12765,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F883_7236)
EIF_TYPED_VALUE F883_7236 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 882, Current, 0, 0, 12765);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(882, Current, 12765);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {882,255,0xFF11,218,0xFFFF};
	...
	*((EIF_REFERENCE *)tr2+6) = (EIF_REFERENCE) tr3;
	...
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVPF(77, 5, "compare_objects", Result))(Result);
	RTVI(Current, RTAL);
	RTRS;
	RTOTE;
	RTHOOK(3);
...
RTOID (F883_7237)
EIF_TYPED_VALUE F883_7237 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 882, Current, 0, 0, 12766);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(882, Current, 12766);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000F1, 0,0); /* Result */
...
RTOID (F883_7238)
EIF_TYPED_VALUE F883_7238 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 882, Current, 0, 0, 12767);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(882, Current, 12767);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000F1, 0,0); /* Result */
...
RTOID (F883_7239)
EIF_TYPED_VALUE F883_7239 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 882, Current, 0, 0, 12768);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(882, Current, 12768);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000F1, 0,0); /* Result */
...
EIF_TYPED_VALUE F883_7240 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F883_7240,12770,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F883_7241 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F883_7241,12771,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F883_7242 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F883_7242,12772,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit883 (void)
{
	GTCX
	RTOTS (7235,F883_7235)
	RTOTS (7236,F883_7236)
	RTOTS (7237,F883_7237)
	RTOTS (7238,F883_7238)
	RTOTS (7239,F883_7239)
	RTOTS (7240,F883_7240)
	RTOTS (7241,F883_7241)
	RTOTS (7242,F883_7242)
}
