...
void egc_init_plug (void)
{
	...
	egc_system_name = "consoleapp";
	egc_system_location = "C:\\Users\\Jorge\\Dropbox\\Programming\\School\\Classes\\Autumn 2013\\Global Software Development\\EiffelProjects\\EIFGENs\\consoleapp\\W_code";
	egc_compiler_tag = 38;
	egc_project_version = 1379975837;
...
void egc_rcdt_init (void)
{
	if (egc_rcdt[0] == 0) {
		...
		egc_rcdt[1] = 933; /* EQA_EVALUATOR */
	}if (egc_rcdt[2] == 0) {
		egc_rcdt[2] = 970; /* ITP_INTERPRETER */
	}
}
