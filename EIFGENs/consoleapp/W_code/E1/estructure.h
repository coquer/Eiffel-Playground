...
struct eif_ex_177 {union overhead overhead; char data [8];};
struct eif_ex_180 {union overhead overhead; char data [8];};
...
struct eif_ex_237 {union overhead overhead; char data [8];};
struct eif_ex_318 {union overhead overhead; char data [8];};
struct eif_ex_436 {union overhead overhead; char data [8];};
struct eif_ex_530 {union overhead overhead; char data [8];};
struct eif_ex_535 {union overhead overhead; char data [8];};
struct eif_ex_539 {union overhead overhead; char data [8];};
struct eif_ex_653 {union overhead overhead; char data [8];};
struct eif_ex_661 {union overhead overhead; char data [8];};
struct eif_ex_669 {union overhead overhead; char data [8];};
struct eif_ex_735 {union overhead overhead; char data [8];};
struct eif_ex_780 {union overhead overhead; char data [8];};
struct eif_ex_803 {union overhead overhead; char data [8];};
struct eif_ex_812 {union overhead overhead; char data [8];};
struct eif_ex_819 {union overhead overhead; char data [8];};
struct eif_ex_827 {union overhead overhead; char data [8];};
