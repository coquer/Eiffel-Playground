...
extern EIF_TYPED_VALUE F911_7627(EIF_REFERENCE);
extern EIF_TYPED_VALUE F911_7628(EIF_REFERENCE);
extern EIF_TYPED_VALUE F911_7629(EIF_REFERENCE);
extern void F911_7630(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
EIF_TYPED_VALUE F911_7627 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 910, Current, 1, 0, 13116);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(910, Current, 13116);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(910, 35, Dtype(Current)))(Current, up1x);
	RTHOOK(3);
...
RTOID (F911_7628)
EIF_TYPED_VALUE F911_7628 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 910, Current, 0, 0, 13117);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(910, Current, 13117);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F911_7629)
EIF_TYPED_VALUE F911_7629 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 910, Current, 0, 0, 13118);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(910, Current, 13118);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000392, 0,0); /* Result */
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {910,706,195,0xFFFF};
...
void F911_7630 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 910, Current, 0, 1, 13119);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(910, Current, 13119);
...
{
	GTCX
	RTOTS (7628,F911_7628)
	RTOTS (7629,F911_7629)
}
