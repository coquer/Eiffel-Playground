...
extern EIF_TYPED_VALUE F915_7640(EIF_REFERENCE);
extern EIF_TYPED_VALUE F915_7641(EIF_REFERENCE);
extern EIF_TYPED_VALUE F915_7642(EIF_REFERENCE);
extern EIF_TYPED_VALUE F915_7643(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F915_7653(EIF_REFERENCE);
extern EIF_TYPED_VALUE F915_7657(EIF_REFERENCE);
extern EIF_TYPED_VALUE F915_7658(EIF_REFERENCE);extern EIF_INTEGER_32 en_socket_address_len();
...
/* {INET_ADDRESS}.ipv4 */
EIF_TYPED_VALUE F915_7640 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F915_7642 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(914,34, Dtype(Current)));
	return r;
}
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 914, Current, 1, 0, 13135);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(914, Current, 13135);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0xF80000DA, 0, 0); /* loc1 */
	
	loc1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(914, 49, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTHOOK(2);
	if ((EIF_BOOLEAN)(loc1 != NULL)) {
		...
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(914, 46, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTNHOOK(4,1);
...
EIF_TYPED_VALUE F915_7657 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(914,49, Dtype(Current)));
	return r;
}
...
EIF_TYPED_VALUE F915_7658 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 914, Current, 0, 0, 13130);
	RTSA(Dtype(Current));
	RTSC;
